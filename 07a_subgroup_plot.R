################################################################################
# Purpose:
# This script generates Figure 3 for the manuscript by plotting pooled cumulative 
# temperature-related relative risks (RR) of road-traffic deaths stratified by 
# sex, age group, and mode of transport. All estimates are based on pooled results
# from 100 imputations using Rubin's rule.
