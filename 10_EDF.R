################################################################################
# Purpose:
# This script calculates the Excess Death Fraction (EDF), also referred to as 
# the Attributable Fraction (AF), and its empirical confidence intervals (CIs) 

# The EDF is computed for:
#   1. Overall effect of extreme heat (e.g., 95–100th percentile temperature)
#   2. Subgroups based on temperature clusters, sex, age, and transportation mode
# The function 'attrdl' is adapted from DLNM documentation to support forward 
# lag structure and simulation-based CIs.
################################################################################
