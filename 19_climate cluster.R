...
col = c("skyblue3",'orange1', "seagreen4",'firebrick2','mediumpurple', 'sienna',"gray30")
par(mfrow = c(2, 3))
par(mar=c(4,5,2,0.5), las=1, mgp=c(2.5,1,0))
plot(pred_reconstruct_pooled[[1]], "overall", lag=0, cumul=TRUE, ylim=c(0.9,1.4), ylab="RR", 
     col=col[1], lwd=1.5, ci='area',lty=1,
     xlab="Cluster 1 (N=21)", ci.arg=list(col=alpha(col[7], 0.1)))
abline(v = c(quan01,quan25,medT,quan75,quan99), lty = 4, col = "gray")
mtext("b", side=3, line=0.1, adj=-0.7, cex=1)

plot(pred_reconstruct_pooled[[2]], "overall", lag=0, cumul=TRUE, ylim=c(0.9,1.4), ylab="RR", 
     col=col[2], lwd=1.5, ci='area',lty=1,
     xlab="Cluster 2 (N=82)", ci.arg=list(col=alpha(col[7], 0.1)))
abline(v = c(quan01,quan25,medT,quan75,quan99), lty = 4, col = "gray")
mtext("c", side=3, line=0.1, adj=-0.7, cex=1)

plot(pred_reconstruct_pooled[[3]], "overall", lag=0, cumul=TRUE, ylim=c(0.9,1.4), ylab="RR", 
     col=col[3], lwd=1.5, ci='area',lty=1,
     xlab="Cluster 3 (N=103)", ci.arg=list(col=alpha(col[7], 0.1)))
abline(v = c(quan01,quan25,medT,quan75,quan99), lty = 4, col = "gray")
mtext("d", side=3, line=0.1, adj=-0.7, cex=1)

plot(pred_reconstruct_pooled[[4]], "overall", lag=0, cumul=TRUE, ylim=c(0.9,1.4), ylab="RR", 
     col=col[4], lwd=1.5, ci='area',lty=1,
     xlab="Cluster 4 (N=30)", ci.arg=list(col=alpha(col[7], 0.1)))
abline(v = c(quan01,quan25,medT,quan75,quan99), lty = 4, col = "gray")
mtext("e", side=3, line=0.1, adj=-0.7, cex=1)

plot(pred_reconstruct_pooled[[5]], "overall", lag=0, cumul=TRUE, ylim=c(0.9,1.4), ylab="RR", 
     col=col[5], lwd=1.5, ci='area',lty=1,
     xlab="Cluster 5 (N=19)", ci.arg=list(col=alpha(col[7], 0.1)))
abline(v = c(quan01,quan25,medT,quan75,quan99), lty = 4, col = "gray")
mtext("f", side=3, line=0.1, adj=-0.7, cex=1)

plot(pred_reconstruct_pooled[[6]], "overall", lag=0, cumul=TRUE, ylim=c(0.9,1.4), ylab="RR", 
     col=col[6], lwd=1.5, ci='area',lty=1,
     xlab="Cluster 6 (N=17)", ci.arg=list(col=alpha(col[7], 0.1)))
abline(v = c(quan01,quan25,medT,quan75,quan99), lty = 4, col = "gray")
mtext("g", side=3, line=0.1, adj=-0.7, cex=1)
